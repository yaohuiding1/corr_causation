%% solve_topo_3node_mediator.m
% Topology: 3-node one-way mediator, 1 -> 3 -> 2.
%
...
% --- symbols ---------------------------------------------------------
syms a11 a22 a33 a23 a31
syms sigmaW1 sigmaW2 sigmaW3

% --- causal matrix A  (a_ij = effect of j on i) ----------------------
% Off-diagonals: a31 (1->3), a23 (3->2).  Edit this block to experiment
% with other parameterizations (e.g. a11 = a22 = a33 = a).
A = [a11    0     0 ;
       0   a22   a23;
     a31    0    a33];
