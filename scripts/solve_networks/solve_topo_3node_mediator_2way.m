%% solve_topo_3node_mediator_2way.m
% Topology: 3-node bidirectional mediator. Node 3 mediates between 1 and 2
% with two-way coupling on both arms (1<->3, 2<->3); no direct 1-2 link.
%
...
% --- symbols ---------------------------------------------------------
syms a11 a22 a33 a13 a23 a31 a32
syms sigmaW1 sigmaW2 sigmaW3

% --- causal matrix A  (a_ij = effect of j on i) ----------------------
% Off-diagonals: a13 (3->1), a23 (3->2), a31 (1->3), a32 (2->3).
A = [a11   0   a13;
       0  a22  a23;
     a31  a32  a33];
